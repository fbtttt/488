...
```{r setup-tibble}
team_data <- tibble(
  name = c("jacob", "mateus", "phoeb", 
           "member 3", "member 4"),
  github_username = c("0xyacob", "mateus11", "username 2", 
                      "username 3", "username 4"), 
  colour = c("plum", "blue", "colour 2", 
             "colour 3", "colour 4"),
  hobby = c("surfing", "football", "hobby 2", 
            "hobby 3", "hobby 4"),
  favourite_number = c(39, NA, NA, NA, NA)
  )
